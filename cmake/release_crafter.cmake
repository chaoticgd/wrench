...
if(ZIP_RELEASE)
	...
	add_custom_target(releasezip ALL
		COMMAND
			...
			${CMAKE_COMMAND} -E copy_directory ${RELEASE_UNDERLAY_DIRECTORY} "${CMAKE_BINARY_DIR}/${RELEASE_NAME}/underlay" &&
			${CMAKE_COMMAND} -E copy_directory ${RELEASE_OVERLAY_DIRECTORY} "${CMAKE_BINARY_DIR}/${RELEASE_NAME}/overlay" &&

...
struct shrubgrouplink { int __value; };
struct dirlightlink { int __value; };
struct pointlightlink { int __value; };
struct envsamplepointlink { int __value; };
struct envtransitionlink { int __value; };
struct cuboidlink { int __value; };
struct spherelink { int __value; };
struct cylinderlink { int __value; };
struct pilllink { int __value; };

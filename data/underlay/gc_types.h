...
struct M2716_SlotMachine {
	...
	int unk54;
	int unk58; /* 0x32 (50) */
	int/*enum M2716_RollResult*/ rollResult; /* Result of the roll, between 0 and 5 */
	...
	int/*enum M2716_RollResult*/ slot1Result;
	int/*enum M2716_RollResult*/ slot2Result;
	int/*enum M2716_RollResult*/ slot3Result;

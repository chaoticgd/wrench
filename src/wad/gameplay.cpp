...
const std::vector<GameplayBlockDescription> gameplay_blocks = {
	...
	{{NONE, NONE}, {0x08, NONE}, {0x04, 0x0b}, bf<TableBlock<Gp_GC_8_DL_4>>(&Gameplay::gc_8_dl_4), "GC 8 DL 4"},
	...
	{{NONE, NONE}, {0x50, NONE}, {0x34, 0x13}, bf<DualTableBlock<Gp_GC_50_DL_34>>(&Gameplay::gc_50_dl_34), "GC 50 DL 34"},
	...
	{{NONE, NONE}, {0x6c, NONE}, {0x50, 0x17}, bf<TableBlock<DualMatrix>>(&Gameplay::gc_6c_dl_50), "GC 6c DL 50"},
	{{NONE, NONE}, {0x70, NONE}, {0x54, 0x18}, bf<TableBlock<DualMatrix>>(&Gameplay::gc_70_dl_54), "GC 70 DL 54"},

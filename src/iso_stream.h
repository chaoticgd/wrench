...
// Handles generating patches from a series of write_n calls generated by the
// rest of the program and loading patches from .wratch files.
//
// An ISO file will be created in the cache/ directory if it doesn't already
// exist. A metadata file containing the hash of the currently applied
// patches and the ranges that have been patched will also be created.
//
// When switching projects, these cache files will have to be regenerated.
